...
resource "aws_cloudwatch_log_group" "[psi[.projectName]]_log_group" {
...
output "[psi[.projectName]]_log_group_name" {
  value = aws_cloudwatch_log_group.[psi[.projectName]]_log_group.name
}

output "[psi[.projectName]]_log_group_arn" {
  value = aws_cloudwatch_log_group.[psi[.projectName]]_log_group.arn
}

# A log stream is a sequence of log events that share the same source.
# Each separate source of logs into CloudWatch Logs makes up a separate log stream.
resource "aws_cloudwatch_log_stream" "[psi[.projectName]]_log_stream" {
