...
#     container_name   = "pac-consul-${var.project_name}"
#     container_port   = "8500"
#   }

#   depends_on = [
#     "aws_lb_listener.consul"
#   ]
# }
...
#   name        = "${var.project_name}-ecs-consul"
#   port        = "8500"
#   protocol    = "HTTP"
...
#
# resource "aws_lb_listener_rule" "consul_host" {
#   listener_arn = "${aws_lb_listener.consul.arn}"
#   priority     = 99
...
#   condition {
#     field  = "host-header"
#     values = ["consul.${var.project_name}.${var.hosted_zone}"]
#   }
# }
...
#   {
#     "cpu": 1024,
#     "image": "118104210923.dkr.ecr.us-east-2.amazonaws.com/consul:srv",
#     "memory": 2048,
